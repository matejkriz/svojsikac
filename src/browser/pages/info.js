  ...
  <Page>
    <div className="message">
      <article>
        ...
        <ul>
          <li className="listItem">run <span className="code">gulp</span></li>
          <li className="listItem">point your browser to localhost:3000</li>
          <li className="listItem">build something beautiful</li>
        </ul>
      </article>
      <article>
        <h2>Dev Tasks</h2>
        <ul>
          ...
          <li className="listItem">
            <span className="code">gulp -p</span>
            <span> run web app in production mode</span>
          </li>
          <li className="listItem">
            <span className="code">gulp -f</span>
